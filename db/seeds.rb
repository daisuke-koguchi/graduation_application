...
User.all.each do |user|
  user.exercises.create!(
    ...
    video:File.open(Rails.root +'public/videos/movie1.mp4'),
    minute: 10,
    second: 0,
    count: 0,
    set_count:0
...
User.all.each do |user|
  user.exercises.create!(
    ...
    video: File.open(Rails.root +'public/videos/movie2.mp4'),
    minute: 0,
    second: 15,
    count: 1,
    set_count:2
...
User.all.each do |user|
  user.exercises.create!(
    ...
    video: File.open(Rails.root +'public/videos/movie3.mp4'),
    minute: 20,
    second: 0,
    count: 1,
    set_count:2
...
User.all.each do |user|
  user.exercises.create!(
    ...
    video: File.open(Rails.root +'public/videos/movie4.mp4'),
    minute: 0,
    second: 0,
    count: 10,
    set_count:2,
...
User.all.each do |user|
  user.exercises.create!(
    ...
    video: File.open(Rails.root +'public/videos/movie5.mp4'),
    minute: 0,
    second: 0,
    count: 10,
    set_count:2,
