...
User.all.each do |user|
  user.exercises.create!(
    ...
    video:File.open('./db/videos/movie1.mp4'),
    minute: 10,
    second: 0,
    count: 0,
    set_count:0
...
#     video: File.open('./public/videos/movie2.mp4'),
#     minute: 0,
#     second: 15,
#     count: 1,
#     set_count:2
...
#     video: File.open('./public/videos/movie3.mp4'),
#     minute: 20,
#     second: 0,
#     count: 1,
#     set_count:2
...
#     video: File.open('./public/videos/movie4.mp4'),
#     minute: 0,
#     second: 0,
#     count: 10,
#     set_count:2,
...
#     video: File.open('./public/videos/movie5.mp4'),
#     minute: 0,
#     second: 0,
#     count: 10,
#     set_count:2,
